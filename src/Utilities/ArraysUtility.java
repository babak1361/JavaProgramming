...
public class ArraysUtility {
    ...
    // print each integer of on integer array in separate lines
    ...
    //print each double of on double array in separate lines
    ...
    //print each char of on char array in separate lines
    ...
    // return the maximum number from the integer Array
    ...
    // return the maximum number from the double Array
