...
public class StringUtility {
    ...
    public static void printEachChart(String str){
        for (int i = 0; i < str.length(); i++) {
            System.out.println(str.charAt(i));
        }
    }

    // returns the given string and then returns the reversed string
    public static String reverse(String str){//"java"
     ...
     public static boolean isPalindrome(String str){
      reverse(str).equalsIgnoreCase(str) ;
    ...
    //removes the duplicates from given string, returns String.  "aaaaabbbcc"  ===> "abc"
