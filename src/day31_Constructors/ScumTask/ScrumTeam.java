...
public class ScrumTeam {
    ...
    public ScrumTeam(String PO, String BA, String SM, ArrayList<Tester> testerList, ArrayList<Developer> developers, int daysOfSprint) {
        this.PO = PO;
        this.BA = BA;
        this.SM = SM;
        this.testerList = testerList;
        this.devopsList = developers;
   ...
   public void removeDeveloper(int employeeID){
    ...
    public String toString() {
        return "ScrumTeam{" +
                ...
                ", BA='" + BA + '\'' +
                ", SM='" + SM + '\'' +
                ", total number of the testers=" + testerList +
                ", total number of the developers=" + devopsList +
