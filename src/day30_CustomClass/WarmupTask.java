...
public class WarmupTask {
    public static void main(String[] args) {
        ...
        int size = list.size();// original size of array
        list.removeAll(Arrays.asList(0));
        System.out.println(list);
        int newSize= list.size();// new size of array
        int totalNumberOfZeros = size -newSize;
        System.out.println(totalNumberOfZeros);// total number of zeros
        ...
        letters.removeIf( p ->!Character.isLetter(p) );//lambda     ** remove each character if is not letter
